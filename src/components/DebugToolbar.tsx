import { BugPlay, Play, Square, ChevronDown } from 'lucide-react';
...
export function DebugToolbar() {
  const { toggleDebugMode, continueAllBreakpoints, continueBreakpoint, breakpoints } = BreakpointsConsumer();
