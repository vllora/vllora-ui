...
export function ConnectGatewayCard() {
  return (
    <div className="group relative p-6 rounded-lg border border-[rgba(var(--theme-500),0.3)] bg-gradient-to-b from-[rgba(var(--theme-500),0.06)] to-transparent hover:border-[rgba(var(--theme-500),0.5)] hover:from-[rgba(var(--theme-500),0.1)] transition-all duration-300 cursor-pointer flex flex-col">
      {/* Recommended badge */}
      ...
      <div className="flex items-center gap-3 mb-4">
        <div className="h-12 w-12 rounded-md bg-gradient-to-br from-[rgba(var(--theme-400),0.15)] to-[rgba(var(--theme-600),0.15)] border border-[rgba(var(--theme-500),0.25)] flex items-center justify-center group-hover:scale-105 transition-transform">
