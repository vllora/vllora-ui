 ...
 * QualityStatsRow
 *
 * Displays key quality metrics spread across the full width.
 * Uses grid layout to evenly distribute stats.
 */
...
export function QualityStatsRow({
  ...
  return (
    <div className="grid grid-cols-4 gap-4 px-4 py-2.5 rounded-lg bg-muted/30 text-xs">
