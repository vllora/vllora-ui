...
const ALL_QUICK_ACTIONS: Record<string, QuickAction> = {
  "start-finetune": { id: "start-finetune", icon: <Rocket className={QA_ICON} />, label: "Start training setup", prompt: "Help me set up fine-tuning for this workflow. Analyze what I have and create a plan." },
  ...
  "start-training": { id: "start-training", icon: <Rocket className={QA_ICON} />, label: "Start training", prompt: "Start the fine-tuning training job with my current workflow configuration." },
};
