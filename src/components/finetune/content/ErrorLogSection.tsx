...
export function ErrorLogSection({ errorMessage }: ErrorLogSectionProps) {
  return (
    <div className="space-y-2">
      ...
      <div className="p-3 bg-red-50 dark:bg-red-950/30 text-red-800 dark:text-red-300 rounded-md text-xs font-mono break-all whitespace-pre-wrap overflow-hidden">
        {errorMessage}
      </div>
    </div>
  );
