        ...
        {showDropdown && (
          ...
          >
            ...
            >
              ...
              {selectedProviders.length === 0 && <Check className="w-4 h-4 text-[rgb(var(--theme-400))]" />}
            </button>
              ...
              {filteredProviders.length > 0 ? (
                filteredProviders.map(provider => (
                  ...
                  >
                    ...
                    {selectedProviders.includes(provider) && <Check className="w-4 h-4 text-[rgb(var(--theme-400))]" />}
                  </button>
                ))
              ) : (
