...
interface TaskIdSeparatorProps {
  spanId: string;
 ...
 */
export const TaskStartSeparator: React.FC<TaskIdSeparatorProps> = ({ spanId, onClick }) => {
  return (
    <div className="flex items-center gap-3 my-6">
      ...
      <button
        ...
        title={`Click to view run: ${spanId}`}
      >
