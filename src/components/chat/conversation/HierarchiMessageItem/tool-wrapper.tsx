...
import {  ToolStartSeparator } from "../SpanSeparator";
import { useState, memo } from "react";
import { INDENT_PER_LEVEL } from "./constants";


export const ToolSpanMessage = memo((props: {
    spanId: string;
    ...
    return <div id={`tool-span-conversation-${spanId}`} className="tool-wrapper" style={indentStyle}>
        <ToolStartSeparator
            spanId={spanId}
