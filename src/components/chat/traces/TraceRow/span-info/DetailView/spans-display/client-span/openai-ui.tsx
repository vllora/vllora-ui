...
export const OpenAIInfoUIDisplay = ({ span }: { span: Span }) => {
    ...
    let input_mime_type = attribute?.['llm.input_mime_type'] || 'text/plain';
    let output_mime_type = attribute?.['llm.output_mime_type'] || 'text/plain';
    let input_value = attribute?.['llm.input.value'];
    let output_value = attribute?.['llm.output.value'];
