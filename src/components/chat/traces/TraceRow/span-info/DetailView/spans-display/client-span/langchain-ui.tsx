...
export const LangchainInfoUIDisplay = ({ span }: { span: Span }) => {
    ...
    let filterOutAttributes = ['openinference.span.kind', 'tool.description', 'metadata', 'langdb_client_name', 'vllora.client_name', 'llm.model_name', 'input.mime_type', 'output.mime_type', 'input.value', 'output.value'];
