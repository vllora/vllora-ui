...
// Props for the FullscreenTimelineContent component
export interface FullscreenTimelineContentProps extends TimelineContentBaseProps { }
// Fullscreen mode timeline content component
export const FullscreenTimelineContent = (props: FullscreenTimelineContentProps) => {
    const {
        level,
        titleWidth,
        title,
    ...
    return (
        <div
            ...
            className="flex-shrink-0 pl-0 py-1.5 pr-3"
        >
            <div className="flex items-center w-full">
                {/* Fake indentation by adding left padding */}
                <div style={{ width: `${level * 12}px` }} className="flex-shrink-0"></div>
                ...
                <div className="flex justify-between items-center w-full">
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <span
                                        ...
                                        style={{ maxWidth: `${Math.max(200 - level * 12, 100)}px` }}
                                    >
                                        {title}
                                    </span>
                                </TooltipTrigger>
                    ...
                    <span className="text-blue-400 text-sm whitespace-nowrap font-mono flex-shrink-0 font-medium">
