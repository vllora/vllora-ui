...
> = {
  improving: {
    epochs: 3,
    rowScores: {
      1: [0.38, 0.32, 0.35, 0.40, 0.30],
      2: [0.55, 0.48, 0.50, 0.52, 0.45],
      3: [0.68, 0.58, 0.60, 0.65, 0.55],
    },
  },
  overfitting: {
    epochs: 4,
    rowScores: {
      1: [0.42, 0.38, 0.40, 0.44, 0.36],
      2: [0.58, 0.52, 0.55, 0.56, 0.50],
      3: [0.50, 0.45, 0.48, 0.47, 0.42],
      4: [0.40, 0.36, 0.38, 0.39, 0.34],
    },
  },
  noLearning: {
    epochs: 3,
    rowScores: {
      1: [0.30, 0.28, 0.32, 0.31, 0.29],
      2: [0.31, 0.29, 0.33, 0.30, 0.30],
      3: [0.30, 0.28, 0.32, 0.31, 0.29],
    },
  },
};
