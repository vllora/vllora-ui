...
export const ProviderCredentialForm = ({
    ...
    switch (providerType.toLowerCase()) {
        ...
        case 'langdb':
            return (
                <div className="text-sm text-muted-foreground p-4 bg-muted/50 rounded-md border border-border">
                    This provider uses hosted LangDB credentials. No additional configuration required.
                </div>
            );
