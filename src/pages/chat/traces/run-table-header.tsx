...
export function RunTableHeader() {
  return (
    <div
      className="grid gap-0 bg-[#0a0a0a] text-xs font-semibold text-muted-foreground uppercase tracking-wider overflow-hidden"
    ...
    >
      ...
      <div className="py-3 px-3 border-r border-border">Run ID</div>
      <div className="py-3 px-3 border-r border-border">Provider</div>
      <div className="flex items-center gap-1 py-3 px-2 border-r border-border justify-center">
