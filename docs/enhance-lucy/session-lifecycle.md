...
- Frontend notification badge in LucySidebar for unreviewed results — backend wiring and comment placeholder exist (line 296), but the visual badge element is not yet rendered
